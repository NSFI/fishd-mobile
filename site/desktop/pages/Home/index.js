        ...
        <div className="content-wrapper">
                ...
                <Link to={`/zh-CN/components/quickStart`} className="button mobile">
                  ...
                  <Popover
                    ...
                    content={
                      <img
                        className="u-qrcode"
                        src="https://nos.netease.com/ysf/9651582ccaba7d6296eed99eb4504c7e.png"
                      />
                    }
                  >
          ...
          <footer className="footer">
            ...
            <div className="link-list">
              ...
              <a href="//nsfi.github.io/ppfish-components/#/components" className="link-item">
                Web 组件
              </a>
              <Link to="/zh-CN/components/quickStart" className="link-item">
                Mobile 组件
              </Link>
              <a href="//nsfi.github.io/ppfish-demo" target="_blank" className="link-item">
                {this.getLocale('misc.demo')}
              </a>
              <a href="//github.com/NSFI/fishd-mobile/issues" target="_blank" className="link-item">
                问题反馈
              </a>
            </div>
